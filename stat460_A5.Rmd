...
**Based on the quantiles previously computed, construct a $95\%$ credible interval for the paramters; based on them, comment on the significance of the parameters.**
